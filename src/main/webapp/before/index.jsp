        ...
        <div class="container">
            <span>欢迎来到Y先生教育！</span>
	            ...
	            <div id="userBlock" style="display:none;float:right">
	               ...
	               <a href="../user/showMyProfile.do" id="account">${sessionScope.loginUser.email}</a>
	            </div>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/list.do?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/course/list.do?subjectId=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/list.do?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/list.do?subjectId=11">
    ...
    <div class="mask hidden" id="login">
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="loginForm" action="#" onsubmit="return commitLogin();">
                    <h3>快速登录</h3>
