...
<body class="w100">
    ...
    <div id="app" >
        <!--banner图-->
        <div class="banner" style="background-image: url(${pageContext.request.contextPath}/img/banner-${subject.subjectId}.jpg)"></div>
    ...
    <script type="text/javascript">
        ...
        function getVideo(videoId){
        	...
        	if((null!="${sessionScope.loginUser}" && "${sessionScope.loginUser}" !="") || ($("#isLogin").val()==1)){
        		//如果登录
            	location.href="${pageContext.request.contextPath}/video/showVideo.do?videoId="+videoId+"&subjectName="+'${subject.subjectName}';
        	}else{
        		//如果不登录，弹登录框
