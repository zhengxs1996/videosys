       ...
       $(function(){
          ...
          $("#oldPassword").blur(function(){
                ...
                if(null!=oldPass && oldPass!=""){
                    if (oldPass ==${sessionScope.loginUser.password}) {
        ...
        <menu>
            <div class="container clearfix">
                ...
                <div id="user_bar">
                    ...
                    <a href="${pageContext.request.contextPath}/before/index.jsp" id="lay_out">退出</a>
                </div>
            </div>
        </menu>
    </header>
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    ...
                    <li><a href="${pageContext.request.contextPath}/before/change_avatar.jsp">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="${pageContext.request.contextPath}/before/password_safe.jsp">密码安全</a></li>
                </ul>
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                           ...
                           <c:if test="${empty sessionScope.loginUser.imgUrl}">
		                      ...
		                      <c:if test="${not empty sessionScope.loginUser.imgUrl}">
		                         <img id="avatar" width="180px" height="180px" src="${pageContext.request.contextPath}/img/${sessionScope.loginUser.imgUrl}" alt="">
		                      </c:if>
    ...
    $("form").submit(function () {
        $.ajax({
            ...
            success:function (data) {
                if (data.code == 1) {
                    alert(data.info);
                    window.location.reload("${pageContext.request.contextPath}/before/my_profile.jsp");
                } else {
                    alert(data.info);
                }
            },
